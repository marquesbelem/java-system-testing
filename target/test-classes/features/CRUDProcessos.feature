...
Funcionalidade: CRUD de Processos
  ...
  Contexto:
    ...
    E  o usuario informar "processo_partes" com o valor igual a "Camila e Gabriel"
    E  o usuario selecionar "processo_urgente" com o valor igual a "Não"
    E  o usuario escolher "processo_arbitramento" com o valor igual a "Sim"
  ...
  Esquema do Cenario: Selecionar o Processo criado
    ...
    Exemplos:
      ...
      |43       |Vila Prudente |Civil   |Camila e Gabriel|
